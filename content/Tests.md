...
**Normas Clave y sus Áreas:**
- **Cables y Conductores:** 
	- IRAM 2183 (PVC)
	- IRAM 2039
	- 2188 (cordones flexibles)
	- IRAM-NM 247-3 (unipolar)
	- IRAM 62267 (libres de halógenos).
- **Instalaciones Fijas:** 
	- IRAM 2220
	- 2261
	- 2262 (cañerías, bandejas).
- **Componentes:** 
	- IRAM 2063 (fichas sin toma tierra)
	- IRAM 2071 (tomacorrientes)
	- IRAM 2073 (fichas con toma tierra)
	- IRAM-NM 60669-1 (interruptores)
- **Puesta a Tierra:** 
	- IRAM 2281 (mediciones y sistemas).
- **Protección:** 
	- IRAM 2301 (protección por corriente de fuga).
- **Canalizaciones:** 
	- IRAM-IEC 61386 (cañerías de material aislante)

![[Pasted image 20251229193928.png]]
